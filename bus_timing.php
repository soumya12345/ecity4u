...
<script type="text/javascript">
		function bus(){
		  var to=$("#to").val();
		   var from=$("#from").val();
		   $.ajax({url:"bustime.php?to="+to+'&frm='+from,success:function(result){
                $("#show").html(result);
                }
		});
		}
...
<body>
	...
	<div id="container" style="height:auto; margin-top:20px; margin-bottom: 20px;">
		<div id="container_content" style="height:0px;">
			...
			<div class="rightbox">
			   <div style="text-align: center; font-family: fantasy;">Bus Timing</div>
			   <table>
			      <tr>
				 <td>To</td>
				 ...
				 <td><input type="text" name="from" id="from" required/></td>
			      ...
			      <tr>
				 <td colspan="2" align="center"><input type="submit" name="submit" value="submit" onClick="bus()"></td>
			      </tr>
			      <tbody id="show"></tbody>
			   </table>
			</div>
