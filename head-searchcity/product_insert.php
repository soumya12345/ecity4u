...
$lat=$_POST['lat'];
$lng=$_POST['lng'];
mysql_query("insert into `product` set `productname`='$product',`city`='$city',`contact`='$contact',`email`='$email',`image`='$prdouctimage',`description`='$description',`category`='$category',`chcategory`='$chcat',`chtype`='$chtype',`totalcombination`='$alltotal',`lat`='$lat',`lng`='$lng'")or die(mysql_error());
